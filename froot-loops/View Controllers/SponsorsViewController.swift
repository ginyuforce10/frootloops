...
class SponsorsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var proName = [String]()
    var newProName: String = ""
    
    var raised = [String]()
    var newRaised: String = ""
    
    var goal = [String]()
    var newGoal: String = ""
    
    var pdescription = [String]()
    var newPdescription: String = ""
